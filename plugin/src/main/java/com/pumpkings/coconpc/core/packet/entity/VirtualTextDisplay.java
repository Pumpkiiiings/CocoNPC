...
public class VirtualTextDisplay extends VirtualEntity {
    ...
    public void updateMetadata(Player player) {
        ...
        metadata.add(new EntityData<>(15 + off, EntityDataTypes.BYTE, billboard));
        byte entityFlags = visible ? (byte) 0 : (byte) 0x20;
        metadata.add(new EntityData<>(0, EntityDataTypes.BYTE, entityFlags));
        metadata.add(new EntityData<>(12 + off, EntityDataTypes.VECTOR3F, scale));
        metadata.add(new EntityData<>(23 + off, EntityDataTypes.ADV_COMPONENT, text));
        metadata.add(new EntityData<>(25 + off, EntityDataTypes.INT, backgroundColor));
        metadata.add(new EntityData<>(26 + off, EntityDataTypes.BYTE, textOpacity));
        metadata.add(new EntityData<>(27 + off, EntityDataTypes.BYTE, styleFlags));
